...
Configarr is a powerful configuration and synchronization tool designed for Sonarr v4+ and Radarr v5+. It streamlines the process of managing custom formats and quality profiles by automatically synchronizing settings from TRaSH-Guides while supporting additional customizations.
...
<div style={{ textAlign: "center" }}>
  <img src="https://star-history.dera.page/svg?repos=raydak-labs/configarr&type=Date" title="Github Star History" />
</div>
