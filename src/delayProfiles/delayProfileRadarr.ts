...
import { DelayProfileResource, DownloadProtocol } from "../__generated__/radarr/data-contracts";
...
export class DelayProfileRadarrSync extends StandardDelayProfileSync<DelayProfileResource> {
  protected getApi() {
