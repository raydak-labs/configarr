 ...
 * tags and sync profiles first (so the rest can reference them by name), then indexer
 * proxies, indexers and applications. Each sync no-ops when its section is absent.
 * Download clients are handled separately by the shared syncer.
 *
